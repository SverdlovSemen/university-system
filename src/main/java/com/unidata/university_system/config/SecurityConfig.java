    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/faculties/{id}").hasAnyRole("ADMIN","EDITOR","UNIVERSITY_ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/faculties/{id}").hasAnyRole("ADMIN","EDITOR","UNIVERSITY_ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/specialties").hasAnyRole("ADMIN","EDITOR","UNIVERSITY_ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/specialties/{id}").hasAnyRole("ADMIN","EDITOR","UNIVERSITY_ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/specialties/{id}").hasAnyRole("ADMIN","EDITOR","UNIVERSITY_ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/subject-combinations").hasAnyRole("ADMIN","EDITOR","UNIVERSITY_ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/subject-combinations/{id}").hasAnyRole("ADMIN","EDITOR","UNIVERSITY_ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/subject-combinations/{id}").hasAnyRole("ADMIN","EDITOR","UNIVERSITY_ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/cities/import").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/universities/import").hasRole("ADMIN")
